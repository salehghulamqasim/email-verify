...
st.info(
    ...
    "🔄 **Upload button stuck / not working?** Click the **Reset** button below, then try again. "
...
# It reloads the upload widget from scratch, which fixes it in almost
# all cases without needing to clear browser cache or use incognito.
# ------------------------------------------------------------------
if "uploader_key" not in st.session_state:
    st.session_state.uploader_key = 0

if st.button("🔄 Reset (click here if upload isn't working)"):
